...
export function QuoteFab() {
  ...
  // The booking/callback drawers have their own close button; don't let this FAB
  // (fixed, higher z-index) float on top of them and intercept clicks meant for
  // the drawer below.
  if (bookingDrawerOpen || callbackDrawerOpen) return null
