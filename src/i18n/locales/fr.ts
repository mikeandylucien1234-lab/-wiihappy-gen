...
export const fr = {
  ...
  admin: {
    ...
    politiques: {
      ...
      subtitle: 'Le texte que vous enregistrez ici apparaît immédiatement sur les pages publiques correspondantes.',
      loading: 'Chargement...',
      localeLabels: { fr: 'Français', en: 'English', es: 'Español' },
      saved: '✓ Enregistré',
      save: 'Enregistrer',
    ...
    faq: {
      title: 'FAQ',
      subtitle: 'Gérez les questions affichées dans la section "Questions fréquentes" du site.',
      loading: 'Chargement...',
